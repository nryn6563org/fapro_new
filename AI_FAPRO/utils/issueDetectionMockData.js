...
export const issueData = [
  ...
  },
  {
    ...
    prevComparison: {
      ...
      description:
        "FDA 승인 기대감이 높아지며 지난주 대비 이슈 강도와 관련 종목 수가 증가했습니다.",
    },
  ...
  },
  {
    ...
    prevComparison: {
      ...
      description:
        "북미 시장 진출 가시화로 지난주 대비 이슈 강도가 증가했습니다.",
    },
  ...
  },
  {
    ...
    prevComparison: {
      ...
      description:
        "대기업 스마트 팩토리 투자 확대 발표로 지난주 대비 이슈 강도가 급증했습니다.",
    },
    issueDate: "2026.02.11",
    updatedAt: "16:10",
  },
  {
    ...
    aiReason:
      "한국 냉동김밥, 라면 등 K-푸드의 북미 및 유럽 수출이 폭발적으로 증가하며 식품 관련주들이 신고가를 기록하고 있습니다. 특히 현지 유통망 확보에 성공한 기업들의 영업이익률이 크게 개선되고 있습니다.",
    outlook:
      "서구권의 건강식(K-Food) 선호 트렌드가 지속되면서 2026년에도 두 자릿수 수출 성장률이 예상됩니다. 현지 공장 증설을 통해 물류비를 절감한 기업들이 시장 점유율을 독식할 것으로 보입니다.",
    newsSummary:
      "냉동김밥이 미국 대형 마트에서 연일 완판 행진을 기록하며 관련 식품 수출액이 역대 최대치를 경신했습니다.",
    newsSources: [
  ...
  },
  {
    ...
    aiReason:
      "비트코인 신고가 돌파와 이더리움 현물 ETF 승인 기대감으로 가상자산 관련주 및 블록체인 게임주들의 거래대금이 급증하고 있습니다. 제도권 편입 가속화로 관련 생태계의 성장이 예상됩니다.",
    outlook:
      "반감기 이후 공급 부족과 기관 투자자 유입으로 2026년 상반기까지 강세장이 지속될 가능성이 높습니다. 다만 변동성이 매우 크므로 관련 기술력과 실제 수익 모델을 보유한 기업 중심으로 필터링이 필요합니다.",
    newsSummary:
      "비트코인이 사상 최고가를 경신하며 가상자산 관련주들이 일제히 급등했습니다. 제도권 금융의 관심이 집중되고 있습니다.",
    newsSources: [
