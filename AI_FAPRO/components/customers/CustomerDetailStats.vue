  ...
  <div class="customer-stats">
    <div class="customer-stats__grid">
      ...
      <div class="customer-stats__card customer-stats__card--blue">
        <h4 class="customer-stats__label customer-stats__label--blue">총 투자금액</h4>
      ...
      <div class="customer-stats__card customer-stats__card--green">
        <h4 class="customer-stats__label customer-stats__label--green">현재 평가금액</h4>
      ...
      <div class="customer-stats__card customer-stats__card--orange">
        <h4 class="customer-stats__label customer-stats__label--orange">예수금</h4>
      ...
      <div class="customer-stats__card customer-stats__card--teal">
        <h4 class="customer-stats__label customer-stats__label--teal">총 수익률</h4>
        <div class="customer-stats__value-box">
          <trending-up-icon v-if="isPositiveReturn" class="customer-stats__icon" />
