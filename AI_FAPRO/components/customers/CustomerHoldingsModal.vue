    ...
    <div class="customer-holdings__modal animate__animated animate__zoomIn">
      ...
      <div class="customer-holdings__body">
        ...
        <div class="customer-holdings__sum-grid">
          ...
          <div class="customer-holdings__sum-card customer-holdings__sum-card--green">
          ...
          <table class="customer-holdings__table">
            ...
            <tbody>
              <tr v-for="(holding, index) in customer.holdingDetails" :key="index">
                ...
                <td class="customer-holdings__td customer-holdings__td--rate">{{ holding.profitRate }}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="customer-holdings__ai-analysis">
          <div class="customer-holdings__ai-header">
            ...
            <div>
              ...
              <p class="customer-holdings__ai-subtitle">포트폴리오 및 투자 성향 분석</p>
            </div>
          </div>
          <div class="customer-holdings__ai-content">
            <div class="customer-holdings__ai-item">
              <div class="customer-holdings__dot customer-holdings__dot--teal"></div>
              <p class="customer-holdings__ai-text">
                <span class="customer-holdings__ai-text--bold">투자 성향:</span>
                {{ customer.investmentType }} 고객으로 현재 포트폴리오는 성장주 중심으로 구성되어
                있습니다.
              </p>
            </div>
            <div class="customer-holdings__ai-item">
              <div class="customer-holdings__dot customer-holdings__dot--teal"></div>
              <p class="customer-holdings__ai-text">
                <span class="customer-holdings__ai-text--bold">수익률 분석:</span> 전체 포트폴리오가
                +15.02%의 양호한 수익률을 보이고 있으며, 모든 보유 종목이 수익 상태입니다.
              </p>
            </div>
            <div class="customer-holdings__ai-item">
              <div class="customer-holdings__dot customer-holdings__dot--amber"></div>
              <p class="customer-holdings__ai-text">
                <span class="customer-holdings__ai-text--bold-amber">추천 액션:</span> 섹터 다각화를
                통한 리스크 분산을 고려해보시고, 2차전지 또는 바이오 섹터 추가 편입을 제안합니다.
              </p>
            </div>
          </div>
        </div>
