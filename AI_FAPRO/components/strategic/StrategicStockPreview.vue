<template>
  <div class="strategic-modal__preview">
    ...
    <div class="strategic-modal__detail-grid">
       <!-- Upside Driver -->
      <div class="strategic-modal__detail-section strategic-modal__detail-section--upside">
        ...
        <ul class="strategic-modal__point-list text-emerald-700">
          <li v-for="(insight, idx) in stock.upside" :key="idx" class="strategic-modal__point-item">
       ...
       <!-- Risk -->
      <div class="strategic-modal__detail-section strategic-modal__detail-section--risk">
        ...
        <ul class="strategic-modal__point-list text-red-600">
          <li v-for="(risk, idx) in stock.downside" :key="idx" class="strategic-modal__point-item">
