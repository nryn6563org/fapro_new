<template>
  <div class="strategic-modal__form-group">
    <div class="strategic-modal__form-header">
       ...
       <span class="strategic-modal__client-summary-count">{{ internalSelectedClients.length }}명 선택됨</span>
    </div>
      ...
      >
        ...
        <label :for="'client-' + client.id" class="strategic-modal__client-label">
          <div class="strategic-modal__client-info">
            <div>
              <p class="strategic-modal__client-name">{{ client.name }} <span class="strategic-modal__client-email">{{ client.email }}</span></p>
            </div>
