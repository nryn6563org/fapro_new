<template>
  <modal-vanilla v-if="isOpen" :is-open="isOpen" modal-id="strategic-proposal-modal"
    custom-dialog-class="strategic-modal__dialog" @close="closeModal">
    <!-- Header Component -->
    <template #header>
      <div class="strategic-modal__header">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M21.8541 2.14697L10.9141 13.086" stroke="#999" stroke-width="2" stroke-linecap="round"
        ...
        <div class="strategic-modal__form-section">
          ...
          <div class="strategic-modal__form-group-item">
            ...
            <div class="strategic-modal__delivery-tabs">
              <button
                :class="['strategic-modal__delivery-tab', transmissionMethod === 'sms' ? 'strategic-modal__delivery-tab--active' : '']"
                @click="transmissionMethod = 'sms'">
                <phone-icon class="strategic-modal__tab-icon" />
                문자
              </button>
              <button
                :class="['strategic-modal__delivery-tab', transmissionMethod === 'kakao' ? 'strategic-modal__delivery-tab--active' : '']"
                @click="transmissionMethod = 'kakao'">
                <message-circle-icon class="strategic-modal__tab-icon" />
                카카오톡
              </button>
              <button
                :class="['strategic-modal__delivery-tab', transmissionMethod === 'email' ? 'strategic-modal__delivery-tab--active' : '']"
          ...
          <div class="strategic-modal__form-group-item">
            ...
            <div class="strategic-modal__message-preview-container">
              <div class="strategic-modal__message-preview-card">
                <textarea v-model="messageSample" class="strategic-modal__textarea-message"
                  placeholder="전송될 메시지 내용입니다."></textarea>
              </div>
            </div>
          </div>
        </div>
