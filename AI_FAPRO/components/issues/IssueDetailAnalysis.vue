<template>
  <div class="issue-detail__extra-info flex flex-col gap-6">
    <!-- Analysis Reason -->
    <div>
      <div class="issue-detail__section-label">
        <div class="fapro-badge fapro-badge--amber fapro-badge--sm mr-2">10</div>
    ...
    <div>
      <div class="issue-detail__section-label">
        <div class="fapro-badge fapro-badge--blue fapro-badge--sm mr-2">11</div>
      ...
      <div class="issue-detail__info-box issue-detail__info-box--blue">
        ...
        <div
          v-if="issue.positiveProspects || issue.negativeProspects"
          class="issue-detail__outlook-grid"
        >
