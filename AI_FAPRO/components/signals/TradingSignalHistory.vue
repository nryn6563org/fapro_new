        ...
        <div class="trading-signal-history__period-toggles">
          <label class="trading-signal-history__radio-label">
            <input
              ...
              type="radio"
              value="3m"
              class="trading-signal-history__radio"
            />
        ...
        <table class="trading-signal-history__table">
          <thead>
            <tr>
              ...
              <th
                class="trading-signal-history__th trading-signal-history__table-right"
              >
                신호발생가격
              </th>
              <th
          ...
          <tbody>
            <tr v-for="(trade, idx) in signal.tradeHistory" :key="idx">
              <td
                class="trading-signal-history__td"
                :class="{
                  'trading-signal-history__td--last':
                    idx === signal.tradeHistory.length - 1,
                }"
              >
                {{ trade.date }}
              </td>
              ...
              >
                <span
                  ...
                  :class="
                    trade.signal === '매수'
                      ? 'trading-signal-history__badge--buy'
                      : 'trading-signal-history__badge--sell'
                  "
                >
                  {{ trade.signal }}
                </span>
              ...
              <td
                class="trading-signal-history__td trading-signal-history__table-right"
                :class="{
                  'trading-signal-history__td--last':
                    idx === signal.tradeHistory.length - 1,
                }"
