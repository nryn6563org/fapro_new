    ...
    <div class="ai-report-investment__card">
      ...
      <div class="ai-report-investment__card-body">
        <p class="ai-report-investment__text">
          {{ signal?.aiReport || '기업에 대한 설명 및 상세 분석 내용이 제공됩니다.' }}
        </p>
        ...
        <div class="ai-report-investment__chart-container">
          <div class="ai-report-investment__chart-legend">
            <div class="ai-report-investment__legend-item">
              ...
              <span class="ai-report-investment__legend-text">Quarterly EPS Announcement</span>
            </div>
            <div class="ai-report-investment__legend-item">
              <span class="ai-report-investment__legend-line"></span>
              <span class="ai-report-investment__legend-text">200-Day Moving Average</span>
            </div>
          </div>
          ...
          <div class="ai-report-investment__chart-mock">
            ...
            <div class="ai-report-investment__chart-svg-wrapper">
              <svg viewBox="0 0 300 100" preserveAspectRatio="none" class="ai-report-investment__chart-svg">
                ...
                <path d="M 0 60 L 50 45 L 100 55 L 150 35 L 200 50 L 250 40 L 300 30" fill="none" stroke="#3B82F6" stroke-width="2" />
                <path d="M 0 60 L 50 45 L 100 55 L 150 35 L 200 50 L 250 40 L 300 30 L 300 100 L 0 100 Z" fill="url(#chartGradient)" />
              ...
              <span class="ai-report-investment__data-point ai-report-investment__data-point--3"></span>
            </div>
            <div class="ai-report-investment__chart-y-axis">
              <span>250K</span>
    ...
    <div class="ai-report-investment__card">
      ...
      <div class="ai-report-investment__card-body ai-report-investment__card-body--padded">
        ...
        <p class="ai-report-investment__subtext">
          Stock picked overall analyst advantage of staying (ACM) is based on the performance of the market and fundamental, technical, 
          and sentiment features that overall analysts use during the previous year. Alpha signals explain the probability advantage of ACM alpha signals.
        </p>
      </div>
    </div>
  </div>
