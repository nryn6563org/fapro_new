...
.c-ranking-modal__header {
  @apply flex items-center justify-between p-6 bg-gradient-to-r from-purple-600 to-indigo-500 text-white;
}
...
.c-ranking-modal__body {
  @apply p-8 overflow-y-auto flex-1;
}

.c-ranking-modal__footer {
  @apply p-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 flex justify-end gap-2;
}
