<template>
  <div class="c-customer-stock-ranking">
    <div class="c-customer-stock-ranking__header">
      <div class="c-customer-stock-ranking__title-group">
        <TrendingUp class="c-customer-stock-ranking__icon" :size="18" />
        <h3 class="c-customer-stock-ranking__title">고객 보유종목 랭킹</h3>
      </div>
      <div class="c-customer-stock-ranking__info">
        <span class="c-customer-stock-ranking__time">08:45</span>
        <button class="c-customer-stock-ranking__refresh">
          <RefreshCw :size="14" />
        </button>
      </div>
    </div>

    <div class="c-customer-stock-ranking__body">
      <div class="c-ranking-rows">
        <div v-for="(item, index) in ranking" :key="item.name" class="c-ranking-row">
          <div class="c-ranking-row__main">
            <span class="c-ranking-row__rank">{{ index + 1 }}</span>
    ...
    <div class="c-customer-stock-ranking__footer">
      <button class="c-customer-stock-ranking__more-btn">더보기</button>
    </div>
  </div>
</template>
...
export default {
  name: 'DashboardCustomerStockRanking',
  ...
  data() {
    return {
      ranking: [
        ...
        { name: 'POSCO홀딩스', change: 1.2, holders: 5, indicatorColor: '#2563EB', barColor: '#EF4444', percent: 30 },
        { name: 'KB금융', change: 0.5, holders: 4, indicatorColor: '#CA8A04', barColor: '#EF4444', percent: 25 },
        { name: '신한지주', change: -0.2, holders: 3, indicatorColor: '#2563EB', barColor: '#3B82F6', percent: 20 }
      ]
    }
  }
}
...
<style scoped>
@import '@/assets/css/page/dashboard/customer-stock-ranking.css';
</style>
